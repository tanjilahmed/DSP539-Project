#Final Version: gene weight corrected; date: 5/10/18 10:09 PM
import sys
import numpy as np
import math
import pandas as pd
...
if __name__=="__main__":
    ...
    if file_format_check(fasta)==True:
        ...
        # df.to_csv("0.20-10.txt",index=False, sep=' ', header=True)
        print(w_cmax)
        print(l_cmax)
        for t in range(0,c+1):
            print("Cluster:",t+1,len(cluster[t]))

##*****C,CN,WLN, increase + H_At calculate korte hobe for new cluster
